...
class SettingsTests(unittest.TestCase):
    def test_load_default_settings(self) -> None:
        ...
        self.assertFalse(settings.window_border.enabled)
        self.assertEqual(settings.window_border.color, "#00a6ff")
        self.assertEqual(settings.window_border.width, 2)
        self.assertEqual(settings.window_border.style, "solid")
